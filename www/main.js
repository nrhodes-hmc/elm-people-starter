...
var $author$project$Main$Model = F2(
	function (people, nextId) {
		return {nextId: nextId, people: people};
	});
var $author$project$Main$Person = F5(
	function (name, email, phone, selected, id) {
		return {email: email, id: id, name: name, phone: phone, selected: selected};
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2(
			...
			_List_fromArray(
				[
					A5($author$project$Main$Person, 'neil', 'foo', '123kdk3\'', false, 1234),
					A5($author$project$Main$Person, 'obama', 'bar', '990943 3 3 9', true, 1235)
				]),
			1236),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$CreatePersonWithId = function (a) {
	return {$: 'CreatePersonWithId', a: a};
};
		...
		switch (msg.$) {
			case 'ChangeName':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							people: A2($elm$core$List$map, updatePerson, model.people)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeEmail':
				var id = msg.a;
			...
			case 'CreatePerson':
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Main$CreatePersonWithId,
						A2($elm$random$Random$int, 1, 9999999)));
			case 'CreatePersonWithId':
				var id = msg.a;
				var _v1 = A2($elm$core$Debug$log, 'newId', id);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							people: _Utils_ap(
								...
								_List_fromArray(
									[
										A5($author$project$Main$Person, '', '', '', false, id)
									]))
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$CreatePerson = {$: 'CreatePerson'};
...
var $author$project$Main$ChangeEmail = F2(
	function (a, b) {
		return {$: 'ChangeEmail', a: a, b: b};
	});
var $author$project$Main$ChangeName = F2(
	function (a, b) {
		return {$: 'ChangeName', a: a, b: b};
	});
var $author$project$Main$ChangePhone = F2(
	function (a, b) {
		return {$: 'ChangePhone', a: a, b: b};
	});
var $author$project$Main$ChangeSelected = F2(
	function (a, b) {
		return {$: 'ChangeSelected', a: a, b: b};
	});
...
var $author$project$Main$taskToRow = function (task) {
	var id = task.id;
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$checked(task.selected),
								$elm$html$Html$Events$onCheck(
								$author$project$Main$ChangeSelected(id))
							]),
						_List_Nil)
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$ChangeName(id))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(task.email),
								$elm$html$Html$Events$onInput(
								$author$project$Main$ChangeEmail(id))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(task.phone),
								$elm$html$Html$Events$onInput(
								$author$project$Main$ChangePhone(id))
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Main$view = function (model) {
	var total = $elm$core$List$length(model.people);
	var selectAllMsg = $author$project$Main$SelectAll;
	var numSelected = $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (x) {
				return x.selected;
	...
	return A2(
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'People, (' + ($elm$core$String$fromInt(numSelected) + ('/' + ($elm$core$String$fromInt(total) + ' selected)'))))
						])),
					A2(
					$elm$html$Html$table,
					_List_Nil,
					_List_fromArray(
						[
												...
												[
													...
													_List_fromArray(
														[
															...
															_Utils_eq(total, numSelected) && (total > 0)),
															$elm$html$Html$Events$onCheck(selectAllMsg)
														]),
													_List_Nil)
												])),
											A2(
							...
							$elm$html$Html$tbody,
							_List_Nil,
							A2($elm$core$List$map, $author$project$Main$taskToRow, model.people))
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$CreatePerson)
						]),
					_List_fromArray(
						[
			...
			(numSelected <= 0) ? _List_Nil : _List_fromArray(
				[
					A2(
					$elm$html$Html$button,
					_List_fromArray(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ChangeName":["Basics.Int","String.String"],"ChangeEmail":["Basics.Int","String.String"],"ChangePhone":["Basics.Int","String.String"],"ChangeSelected":["Basics.Int","Basics.Bool"],"SelectAll":["Basics.Bool"],"CreatePersonWithId":["Basics.Int"],"CreatePerson":[],"DeleteSelected":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));